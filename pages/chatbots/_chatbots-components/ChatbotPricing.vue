			...
			<div class="mt-7 rounded-[32px] border border-gray-100 bg-[#fbfbfb] p-3">
				<div class="rounded-[20px] border border-gray-100 bg-white p-6">
					...
					<p class="font-semibold">
						...
						book a 30-minute or 1-hour consultation session with Zain.
						During the session, you'll learn how we've successfully implemented
						AI in businesses similar to yours, providing insights to help you
